...
def ace_estimator(df, count_col, rare_threshold=10):
...
for file, count_col in files_of_interest.items():
    ...
    S_ACE = ace_estimator(df, count_col, rare_threshold=10)
    S_obs = len(df)
...
output_file = "/kaggle/working/ACE-10_Simplified_Sepsis.csv"
